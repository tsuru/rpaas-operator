...
openapi/generate-http-client:
	...
	@ find ${OPENAPI_AUTOGENERATED_HTTP_CLIENT_DIR} -maxdepth 1 -mindepth 1 -type d ! -name '.openapi-generator' -exec rm -rv {} +
	@ find ${OPENAPI_AUTOGENERATED_HTTP_CLIENT_DIR} -maxdepth 1 -mindepth 1 -type f ! -name '.openapi-generator-ignore' -exec rm -v {} +
