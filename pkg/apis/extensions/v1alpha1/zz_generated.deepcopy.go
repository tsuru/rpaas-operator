...
func (in *RpaasInstanceSpec) DeepCopyInto(out *RpaasInstanceSpec) {
	*out = *in
	...
	if in.TLSSessionResumption != nil {
		...
		*out = new(TLSSessionResumptionMode)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSSessionResumptionMode) DeepCopyInto(out *TLSSessionResumptionMode) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSSessionResumptionMode.
func (in *TLSSessionResumptionMode) DeepCopy() *TLSSessionResumptionMode {
	if in == nil {
		return nil
	}
	out := new(TLSSessionResumptionMode)
