...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocationsBlock) DeepCopyInto(out *LocationsBlock) {
	*out = *in
	if in.Locations != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocationsBlock.
func (in *LocationsBlock) DeepCopy() *LocationsBlock {
	if in == nil {
		return nil
	}
	out := new(LocationsBlock)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RpaasInstanceSpec) DeepCopyInto(out *RpaasInstanceSpec) {
	*out = *in
	...
	if in.LocationsBlock != nil {
		in, out := &in.LocationsBlock, &out.LocationsBlock
		*out = new(LocationsBlock)
		(*in).DeepCopyInto(*out)
	}
