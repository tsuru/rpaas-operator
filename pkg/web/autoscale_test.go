	...
	tests := []struct {
	...
	}{
		{
			...
			manager: &fake.RpaasManager{
				FakeGetAutoscale: func(instance string) (*autogenerated.Autoscale, error) {
		...
		},
		{
			...
			instance:     "my-instance",
			expectedCode: http.StatusOK,
			expectedBody: `{"cpu":60,"maxReplicas":10,"memory":512,"minReplicas":3,"rps":500}`,
			manager: &fake.RpaasManager{
				FakeGetAutoscale: func(instance string) (*autogenerated.Autoscale, error) {
					assert.Equal(t, "my-instance", instance)
					return &autogenerated.Autoscale{
						MinReplicas: 3,
						MaxReplicas: 10,
						Cpu:         autogenerated.PtrInt32(60),
						Memory:      autogenerated.PtrInt32(512),
