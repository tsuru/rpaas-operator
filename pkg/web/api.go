...
func newEcho(targetFactory target.Factory) *echo.Echo {
	...
	group.GET("/:instance/upstream-options", getUpstreamOptions)
	group.POST("/:instance/upstream-options", addUpstreamOptions)
	group.PUT("/:instance/upstream-options/:bind", updateUpstreamOptions)
	group.DELETE("/:instance/upstream-options/:bind", deleteUpstreamOptions)
