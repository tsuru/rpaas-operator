...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoCertificates) DeepCopyInto(out *AutoCertificates) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoCertificates.
func (in *AutoCertificates) DeepCopy() *AutoCertificates {
	if in == nil {
		return nil
	}
	out := new(AutoCertificates)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RpaasInstanceSpec) DeepCopyInto(out *RpaasInstanceSpec) {
	*out = *in
	...
	if in.AutoCertificates != nil {
		in, out := &in.AutoCertificates, &out.AutoCertificates
		*out = new(AutoCertificates)
		(*in).DeepCopyInto(*out)
	}
}
