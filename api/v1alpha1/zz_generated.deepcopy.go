...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RpaasValidationSpec) DeepCopyInto(out *RpaasValidationSpec) {
	*out = *in
	if in.Flavors != nil {
		in, out := &in.Flavors, &out.Flavors
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RpaasValidationSpec.
func (in *RpaasValidationSpec) DeepCopy() *RpaasValidationSpec {
	if in == nil {
		return nil
	}
	out := new(RpaasValidationSpec)
	in.DeepCopyInto(out)
	return out
}
