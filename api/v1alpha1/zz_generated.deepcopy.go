...
func (in *ScaleDown) DeepCopyInto(out *ScaleDown) {
	*out = *in
	...
	if in.UnitsPolicyValue != nil {
		in, out := &in.UnitsPolicyValue, &out.UnitsPolicyValue
		*out = new(int32)
		**out = **in
	}
	if in.PercentPolicyValue != nil {
		in, out := &in.PercentPolicyValue, &out.PercentPolicyValue
		*out = new(int32)
		**out = **in
	}
}
