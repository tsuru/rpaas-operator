...
type RpaasManager struct {
	...
	FakeGetAllowedUpstream    func(instanceName string) (*v1alpha1.RpaasAllowedUpstreams, error)
	FakeDeleteAllowedUpstream func(instanceName, host string, port int) error
}
...
func (m *RpaasManager) GetAllowedUpstreams(ctx context.Context, instanceName string) (*v1alpha1.RpaasAllowedUpstreams, error) {
	if m.FakeGetAllowedUpstream != nil {
		return m.FakeGetAllowedUpstream(instanceName)
	}
	return nil, nil
}

func (m *RpaasManager) DeleteAllowedUpstream(ctx context.Context, instance string, host string, port int) error {
	if m.FakeGetAllowedUpstream != nil {
		return m.FakeDeleteAllowedUpstream(instance, host, port)
	}
	return nil
}
